    ...
    <div className="flex flex-col items-center justify-center text-center py-10 bg-white">
      ...
      <BlurFade>
        <h1 className="text-6xl font-semibold text-black leading-[60px] tracking-[-3px] mb-4">
          Automate your ops. <br /> See all progress in one place.
        </h1>
      ...
      {/* Logo tray */}
      <div className="w-full px-4 my-16 max-w-[1200px] mx-auto">
        <h3 className="text-lg text-center tracking-[-0.8px] text-black font-medium mb-6">
